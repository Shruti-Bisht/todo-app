...
export const  hostname="https://todo-app-server-gold.vercel.app/api/v1"
...
export const taskDelete=`${hostname}/task/taskDelete`
export const taskUpdate=`${hostname}/task/taskUpdate`
